...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Элемент хранилища c индексом 3: " + stringStorage.get(3));
        ...
        try {
            System.out.println("Последний добавленный элемент: " + nameStorage.getLast());
        } catch (NegativeIndexException e) {
            e.printStackTrace();
        }
        ...
        try {
            System.out.println("Последний + первый элемент числового хранилища = " + (numStorage.getLast() + numStorage.get(0)));
        } catch (NegativeIndexException e) {
            e.printStackTrace();
        }
